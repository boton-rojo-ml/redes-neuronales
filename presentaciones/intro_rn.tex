...
\begin{frame}
  \frametitle{Redes con alimentación hacia adelante}
  \begin{center}
    \includegraphics[width= \textwidth]{feedforward.png}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Redes recurrentes}
  \begin{center}
    \includegraphics[width=\textwidth]{recurrent.png}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=.7\textwidth]{ejemplo_0.pdf}
  \end{center}
\end{frame}

\begin{frame}
  \frametitle{Representación de pesos}
   \includegraphics[width=\textwidth]{ejemplo_1.pdf}
...
\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_2.pdf}
...
\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_3.pdf}
\end{frame}

\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_4.pdf}
\end{frame}

\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_5.pdf}
\end{frame}

\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_6.pdf}
\end{frame}

\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_7.pdf}
\end{frame}

\begin{frame}
  \frametitle{Aprendizaje}
   \includegraphics[width=\textwidth]{ejemplo_8.pdf}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.8\textwidth]{ejemplo_9.pdf}
  \end{center}
\end{frame}
...
elementales no linealmente separables.
  \begin{center}
    \includegraphics[width=0.8\textwidth]{xor_perceptron.pdf}
  \end{center}
...
El perceptrón no puede resolver patrones simples con translación.
  \begin{center}
    \includegraphics[width=0.7\textwidth]{tanslacion_perceptron.pdf}
  \end{center}
